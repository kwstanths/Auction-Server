...
int main(int argc, char ** argv){
	...
	getline(myfile,line);
	//num_products = std::stoi(line);


	/*
	 * Auctioneers holds a list of all the auctioneers. Its a list of classes
	 * For each element call the classe's constructor
	 */
	...
	/*
	 * Wait for user to type y or Y and then send the new item to all the auctioneers. TODO (read from file?)
	 */
